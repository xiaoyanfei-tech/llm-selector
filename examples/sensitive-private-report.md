...
Recommended first shortlist: **Local open-source model, Qwen, Kimi**.
...
- Scenarios: Enterprise knowledge base / RAG, Document summary / contract reading
- Data sensitivity: Regulated or highly sensitive data
- Budget: High / quality-first budget
- Deployment preference: Private or local deployment preferred

## Recommended shortlist

### 1. Local open-source model — score 12
...
Provider/ecosystem: Moonshot / Kimi-compatible gateways

Why it fits:
- Strong long-document reading and summarization
- Good fit for research and document-heavy teams

Risks to review:
- May not be the best first choice for coding-agent workflows
- Gateway and context limits should be verified

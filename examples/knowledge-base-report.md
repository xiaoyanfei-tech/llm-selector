...
Recommended first shortlist: **Qwen, Local open-source model, GLM-5.2**.

Primary recommendation: **Qwen** because it best matches the selected scenario, budget, data sensitivity, and deployment preference.
...
Start with **Qwen** as the first candidate and keep the #2 option as a fallback during PoC. Do not scale spend until quality, cost, and endpoint trust are measured with real tasks.

## Inputs

- Scenarios: Enterprise knowledge base / RAG
...
### 2. Local open-source model — score 6
